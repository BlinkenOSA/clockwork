...
urlpatterns = [
    ...
    url(r'^country/popup/create/$', CountryPopupCreate.as_view(), name='country_create_popup'),
    ...
    url(r'^corporation/popup/create/$', CorporationPopupCreate.as_view(), name='corporation_create_popup'),
    ...
    url(r'^person/popup/create/$', PersonPopupCreate.as_view(), name='person_create_popup'),
    ...
    url(r'^language/popup/create/$', LanguagePopupCreate.as_view(), name='language_create_popup'),
    ...
    url(r'^place/popup/create/$', PlacePopupCreate.as_view(), name='place_create_popup'),
    ...
    url(r'^genre/popup/create/$', GenrePopupCreate.as_view(), name='genre_create_popup'),
