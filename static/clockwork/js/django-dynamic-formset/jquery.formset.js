    ...
    $.fn.formset = function(opts)
    {
        ...
        $(this).each(function(i) {
            ...
            if ($(this).is('TR')) {
                ...
                $("div:last", this).append('<a class="' + options.deleteCssClass + ' btn btn-default" href="javascript:void(0)"><i class="fa fa-times"></i></a>');
            }
            $(this).find('a.' + options.deleteCssClass).click(function() {
                // Remove the parent form containing this button:
                var row = $(this).parents('.' + options.formCssClass);

                $(row).find('.delete-row-hidden').prop('checked', true);
                row.hide();
        ...
        if ($(this).length) {
            ...
            if ($(this).attr('tagName') == 'TR') {
                ...
                $(this).filter(':last').after('<a class="' + options.addCssClass + ' btn btn-default" href="javascript:void(0)"><i class="fa fa-plus"></i> ' + options.addText + '</a>');
                $addBtn = $('.' + options.addCssClass);
            }
