...
class Accession(models.Model):
    ...
    method = models.ForeignKey('AccessionMethod', on_delete=models.CASCADE)

    access_note = models.TextField()
    building = models.ForeignKey('controlled_list.Building', on_delete=models.CASCADE)
    ...
    copyright_status = models.ForeignKey('AccessionCopyrightStatus', on_delete=models.CASCADE)
